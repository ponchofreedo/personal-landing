<script setup lang="ts">
  ...
  const links = ref([
    { id: 1, name: 'About me', href:'#about', location:'', hasIcon: 'true', iconName: 'arrow-down' },
    { id: 2, name: 'LinkedIn', href:'https://www.linkedin.com/in/zpfreed', location: '_blank' },
    { id: 3, name: 'Figma', href:'https://www.figma.com/@ponchofreedo', location:'_blank' },
    { id: 4, name: 'GitHub', href:'https://www.github.com/ponchofreedo', location:'_blank' },
    { id: 5, name: 'Dribbble', href:'https://www.dribbble.com/ponchofreedo', location:'_blank' },
    { id: 6, name: 'Instagram', href:'https://www.instagram.com/ponchofreedo', location:'_blank' }
  ])
</script>
