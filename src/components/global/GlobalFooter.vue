    ...
    <main>
      <aside>
        ...
        <p>
          ...
          <a href="https://figma.com" target="_blank">Figma</a>, built with
          <a href="https://vuejs.org" target="_blank">Vue</a>, authored in
          <a href="https://sublimetext.com" target="_blank">Sublime Text</a> (yes, I'm a VS Code
          holdout...for now), and shipped with
          <a href="https://vercel.com" target="_blank">Vercel</a>. Type set in
          <a href="https://pangrampangram.com/products/neue-montreal" target="_blank"
            >Neue Montreal</a
          >
          by Mats Desjardins from
          <a href="https://pangrampangram.com/" target="_blank">Pangram Pangram Foundry</a>. Built
          with controlled chaos and my take on Thomas Keller's
          <a href="https://www.youtube.com/watch?v=EWLt6G85zC4" target="_blank">roast chicken</a>
          recipe (yes, that roast chicken from the season 3 finale of The Bear that Carmy later
          cooks for his mom in season 4). Also built with
          <a href="https://instagram.com/obi_dog__kenobi_/" target="_blank">my dog</a> at my feet.
        </p>
      </aside>
      <section>
        <icon id="anchor" type="icon" name="iconArrowSquareUp" v-on:click.native="scrollToTop()" />
        <p>
          &copy; 2025 Zach Freed &mdash; <span>{{ randomCatchphrase }}</span>
        </p>
      </section>
    </main>
  </footer>
